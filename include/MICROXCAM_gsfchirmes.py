...
main = cdll.LoadLibrary("C:\\Users\\gsfchirmes\\Desktop\\CYCLOPSpanel\\include\\main_gsfchirmes.dll")
...
if __name__ == "__main__":
    cam = MICROXCAM()
    cam.qcl_chop(".\\FOCUS_TEST\\SHORT_EXP_ON_0.csv",".\\FOCUS_TEST\\SHORT_EXP_OFF_0.csv",500) 
    K2220G = K2220G.K2220G()
    K2220G.OUTPUT_OFF(2)
